...
cesc_cli_miRNA_cox_old <- read.csv("mrna+clinical_concordance_by_cox_old.txt",head = F)
cesc_cli_miRNA_cox_new <- read.csv("mrna+clinical_concordance_by_cox_new.txt",head = F)
